...
| --- | --- | --- | --- |
| P01 product-complement criterion | `Construction/ProductCriterion.lean` | open | |
| S01 scaffold interface | `Construction/Scaffold.lean` | open | |
| S02 norm, injectivity, unit gap | `Construction/Scaffold.lean` | open | |
| S03 finite boxes and lattice count | `Construction/Scaffold.lean` | open | |
| D01 digit injectivity | `Construction/Digits.lean` | open | needs S02 |
| D02 decoding inequality | `Construction/Digits.lean` | open | needs S02 |
| Q01 integer parameters | `Construction/Parameters.lean` | open | |
| Q02 thresholds and root bounds | `Construction/Parameters.lean` | open | |
| C01 trace fiber | `Construction/Fibers.lean` | open | needs S03 |
...
| K01 Kummer independence | `MultiQuadratic/Kummer.lean` | open | |
| K02 order, embeddings, conjugations | `MultiQuadratic/Order.lean` | open | |
...
| L01 Legendre choice | `MultiQuadratic/Legendre.lean` | open | |
| L02 reduction map | `MultiQuadratic/Legendre.lean` | open | needs K02 |
| K06 scaffold instance | `MultiQuadratic/Scaffold.lean` | open | needs K03–K05, L02, S01 |
| M01 exponent arithmetic | `Construction/Arith.lean` | open | |
...
| Node | Module | Status | Notes |
| --- | --- | --- | --- |
| F01 degree-bounded polynomial spaces | `LowerBound/PolynomialSpaces.lean` | open | |
| F02 restriction spaces, Hilbert function | `LowerBound/Hilbert/Defs.lean` | open | needs F01 |
| F03 point ideals, jets | `LowerBound/Jets/Defs.lean` | open | needs F01 |
...
| H02 weighted shadow inequality | `LowerBound/Hilbert/Shadow.lean` | open | |
...
| C05 multiplicity choice | `LowerBound/Arithmetic/Multiplicity.lean` | open | |
| C06 assigning lines to components | `LowerBound/Counting/Components.lean` | open | needs F05, B03, C04 |
| C07 weighted selection | `LowerBound/Arithmetic/WeightedSelection.lean` | open | |
