...
# Pins follow the Palomar starter template (PalomarRegistry/PalomarTemplate), except that
# lean4export is pinned to its `v4.33.0-rc1` tag to match this project's `lean-toolchain`.
